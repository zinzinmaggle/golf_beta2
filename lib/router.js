...
Router.route('/games', {
	name: 'gamesList',
	waitOn : function() { return [Meteor.subscribe('users'), Meteor.subscribe('groups'), Meteor.subscribe('games'), subs.subscribe('golf'), subs.subscribe('course') ] },
	onBeforeAction: function() {
...
Router.route('/groups/postsGroup/:_id',{
	name: 'postsGroup',
	data: function() { return Groups.findOne(this.params._id); },
	waitOn : function(){return [Meteor.subscribe('groups'),Meteor.subscribe('users'),Meteor.subscribe('postsgroup')]},
	onBeforeAction: function() {
