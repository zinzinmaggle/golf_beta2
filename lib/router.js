...
Router.route('/explorer/golf/:_id', {
	...
	waitOn: function() { return [subs.subscribe('golf'), subs.subscribe('course')]; }
});
...
Router.route('/network/userProfil', {
	...
	waitOn : function() {return [ Meteor.subscribe('users'),Meteor.subscribe('stuff')]},
	onBeforeAction: function() {
...
Router.route('/network/gallery', {
	name: 'gallery',
	waitOn : function() { return [subs.subscribe('users'),Meteor.subscribe('gallery')] },
	onBeforeAction: function() {
